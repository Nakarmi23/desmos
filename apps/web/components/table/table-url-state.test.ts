...
describe("table URL state", () => {
  ...
  it.each([
    ...
    ["a day that doesn't exist", "f.joined.eq=2024-13-45"],
    ["a day past the month's end", "f.joined.eq=2023-02-29"],
    ["a between bound that doesn't exist", "f.joined.between=2024-02-30.."],
